...
public class ServerHandler {
	...
	private ArrayList<PacketEvent> events = new ArrayList<PacketEvent>(); /**List of all Events that'll be run by the eventDaemon*/
	private ArrayList<ServerEvent> events2 = new ArrayList<ServerEvent>(); /**List of all Events that'll be run by the eventDaemon*/
